...
img_hero = "rocket.png"   # player (hero)
...
for i in range(1, 3):
   asteroid = Obstacle(img_ast, randint(30, win_width - 30), -40, 80, 50, randint(1, 7))
...
while run:
    ...
    if not finish:
        ...
        missed_text = font2.render("Missed: " + str(lost), True, (255, 255, 255))
